...
class Task4SaveTheTribe():
    ...
    def initialize(self):
        ...
        self.monsters.append(Task4Monster(1, random.randint(0, 4) * 10 + 30))
        self.monsters[0].set_pos(4, 1)
        self.monsters[0].add_drop_item(2)
        self.monsters[0].add_drop_item(3)

        self.monsters.append(Task4Monster(2, random.randint(0, 4) * 10 + 30))
        ...
        self.monsters.append(Task4Monster(7, random.randint(0, 4) * 10 + 30))
